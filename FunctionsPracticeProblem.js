...
//Program to check if Number is a pallindrome or not
{
function pallindromeCheck(number1,number2){
...
let pallindrome=pallindromeCheck(191,191);
if(pallindrome==true){
    console.log("Number is Pallindrome");
}else{
    console.log("Number not a pallindrome");
}
}

//Program to check if number is prime and pallindrome
{
